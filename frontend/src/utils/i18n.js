window.I18N = {
  en: {
    ...
    map_score_legend: "Technical fit score",
    ...
    legend_excellent: "High fit (≥ 6.0)",
    legend_strong: "Good fit (5.5–5.9)",
    legend_moderate: "Moderate fit (5.0–5.4)",
    legend_weak: "Lower fit (< 5.0)",
  ...
  tr: {
    ...
    map_score_legend: "Teknik uyum puanı",
    ...
    legend_excellent: "Yüksek uyum (≥ 6,0)",
    legend_strong: "İyi uyum (5,5–5,9)",
    legend_moderate: "Orta uyum (5,0–5,4)",
    legend_weak: "Daha düşük uyum (< 5,0)",
